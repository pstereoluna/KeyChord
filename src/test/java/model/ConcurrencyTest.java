        ...
        for (int i = 0; i < 10; i++) {
            ...
            executor.submit(() -> {
                try {
                    ...
                    // Create an EventSource adapter for Recording
                    Player.EventSource eventSource = new Player.EventSource() {
                        @Override
                        public List<NoteEvent> getEvents() {
                            return recording.getEvents();
                        }
                    };
                    player.startPlayback(eventSource, new Player.NotePlaybackHandler() {
                        @Override
